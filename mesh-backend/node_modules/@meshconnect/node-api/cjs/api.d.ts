...
export interface B2BBrokerAuthRequest {
    ...
    mfaCode?: string | null;
    mfaType?: 'phone' | 'email' | 'totp' | 'phoneAndEmail' | 'requireNextSecurityQuestion' | 'readEmail' | 'face' | 'tradingPin' | 'qrCode' | 'password' | 'roaming' | 'mobile';
...
export interface DeFiWalletVerification {
    ...
    xPubKey?: string | null;
    /** Wallet network type. */
    networkType?: 'unknown' | 'evm' | 'solana' | 'bitcoin' | 'cardano' | 'tron' | 'avalancheX' | 'tezos' | 'dogecoin' | 'ripple' | 'stellar' | 'litecoin' | 'sui' | 'aptos' | 'tvm';
    /** Verification method. */
...
export type MfaType = 'phone' | 'email' | 'totp' | 'phoneAndEmail' | 'requireNextSecurityQuestion' | 'readEmail' | 'face' | 'tradingPin' | 'qrCode' | 'password' | 'roaming' | 'mobile';
...
export type NetworkTransferIneligibilityReason = 'amountNotSufficient' | 'gasFeeAssetBalanceNotEnough' | 'noTargetNetworkFound' | 'refusedByInstitution' | 'eligibleWithFunding' | 'balanceBelowRequestedAmount' | 'requestedAmountBelowMinimum' | 'balanceBelowMinimum' | 'requestedAmountBelowFees' | 'requestedAmountBelowClientMinimum' | 'requestedAmountAboveClientMaximum' | 'noPrice' | 'nyCoinbaseUserRestrictions';
...
export declare class FrontApi<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ...
    quickNode: {
         ...
         * @response `500` `void` Internal Server Error
         */
        v1CatalogSolanaGetLatestBlockhashCreate: (params?: RequestParams) => Promise<AxiosResponse<StringApiResult, any>>;
    };
    transactions: {
        /**
